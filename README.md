...
The removal of ROEs is conducted in two steps, which allows to detect different kinds of ROEs. Results are shown in Fig. 2. Note that the grey lines in Fig. 2 are smooth nonlinear spaces of the pupil signal where it is supposed we can found these slow local turbulences.
